		...
		<div className="body">
			...
			<div className="section">
				...
				<div className="section-content">
					...
					<div className="feature">
						...
						<div className="feature-content">
							Leverage data-driven insights to make informed decisions and stay
			...
			<div className="section-with-img">
				...
				<div className="section-content">
					...
					<p>
						Our SaaS solutions are flexible and can be tailored to your specific
						business requirements. We understand that each organization is
						unique, and we are committed to delivering software that fits your
						needs like a glove.
					</p>
					<button type="button" className="cta-btn">
						Learn more
			...
			<div className="section last">
				...
				<div className="section-content">
					...
					<div className="feature">
						...
						<div className="feature-content">
							Our intuitive user interface ensures your team can hit the ground
							running with minimal training, increasing productivity.
						</div>
					</div>
					<div className="feature">
						<div className="feature-header">Real-time analytics</div>
						<div className="feature-content">
							Gain access to real-time data and analytics, enabling you to make
					...
					<div className="feature">
						...
						<div className="feature-content">
							Count on our dedicated support team for training, troubleshooting,
