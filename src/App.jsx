	...
	return (
		<ThemeProvider>
			<div className="h-screen flex flex-col items-center justify-center gap-1">
				...
				<a href="https://github.com/fagbenjaenoch/mini-frontend-projects" target="_blank" rel="noopener noreferrer" className="mt-3">
					<svg height="25" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="25" data-view-component="true" class="octicon octicon-mark-github v-align-middle color-fg-default">
